// v8.2.6 매매 전략 로직 모듈 (Stoch RSI, ADX, MACD, MA Slope 지표 및 WHAT-IF 연동 지원)
...
console.log(`[LOADED] Logic.v8.2.6.cjs loaded at ${new Date().toISOString()}`);

const strategy = {
    name: 'Logic.v8.2.6',
    description: 'v8.2.6 (MA Slope, ROC & WHAT-IF Filters Support)',
