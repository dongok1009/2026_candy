...
// [v7.0.1 Optimized Edition]
// - Multi-timeframe indicators (5M, 1H, 1D) integration
// - Hybrid entry logic (Immediate vs Retrace)
// - Cumulative ROI & Balance tracking enabled
const config = {
    SYMBOL: 'BTCUSDT',
    LEVERAGE: 5,
    ...
    STOCH_D: 3,
    ADX_PERIOD: 14,
    ENTRY_TYPE: 'hybrid', // immediate | retrace | hybrid
    ENTRY_WAIT_MIN: 60,
    EXIT_WAIT_MIN: 2000
};
