...
// --- Config (v6.0.0 2023 Full Year) ---
const SYMBOL = 'BTCUSDT';
const FETCH_START_TIME = new Date('2022-11-01T00:00:00+09:00').getTime();
const ACTUAL_START_TIME = new Date('2023-01-01T00:00:00+09:00').getTime();
const ACTUAL_END_TIME = new Date('2024-01-01T00:00:00+09:00').getTime();
...
async function runV600Full2023() {
  console.log(`--- [v6.0.0] 2023년 백테스트 ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v600_20230101_20231231_results.csv', output.join('\n'));
  console.log(`\n--- 2023 Full Year Results (v6.0.0) ---`);
