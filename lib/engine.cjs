...
const { calculateEMA, calculateSMA, calculateRSI, calculateMACD, calculateStochRSI, calculateADX } = require('./indicators.cjs');
...
async function runBacktest(strategy) {
    ...
    let cur3m = 0, cur5m = 0, cur1h = 0, cur12h = 0, cur1d = 0;
    for (let idx = 0; idx < klines1m_all.length; idx++) {
