...
TARGET_NET_ROI=0.03
SL_ROI=0.15
REDUCE_TP_WAIT_MIN=60
REDUCED_TARGET_ROI=0.01
...
LONG_5M_USE_STOCH_LIMIT=false
LONG_5M_STOCH_LIMIT_THRESHOLD=80
LONG_5M_USE_MACD_VALUE=false
LONG_5M_MACD_VALUE_THRESHOLD=-10

SHORT_5M_USE_ADX=true
SHORT_5M_ADX_THRESHOLD=30
SHORT_5M_USE_MACD_CROSS=false
SHORT_5M_USE_STOCH_CROSS=true
SHORT_5M_USE_STOCH_LIMIT=false
SHORT_5M_STOCH_LIMIT_THRESHOLD=80
SHORT_5M_USE_MACD_VALUE=false
SHORT_5M_MACD_VALUE_THRESHOLD=10
...
LONG_1H_STOCH_LIMIT_THRESHOLD=80
