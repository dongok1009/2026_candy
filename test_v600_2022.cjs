...
// --- Config (v6.0.0 2022 Full Year) ---
const SYMBOL = 'BTCUSDT';
const FETCH_START_TIME = new Date('2021-11-01T00:00:00+09:00').getTime();
const ACTUAL_START_TIME = new Date('2022-01-01T00:00:00+09:00').getTime();
const ACTUAL_END_TIME = new Date('2023-01-01T00:00:00+09:00').getTime();
...
async function runV600Full2022() {
  console.log(`--- [v6.0.0] 2022년 백테스트 ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v600_20220101_20221231_results.csv', output.join('\n'));
  console.log(`\n--- 2022 Full Year Results (v6.0.0) ---`);
