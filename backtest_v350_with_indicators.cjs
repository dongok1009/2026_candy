...
async function runV350WithIndicators() {
  console.log(`--- [v3.5.0] 백테스트: 지정가 진입 + 재진입 허용 + 지표 포함 CSV ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v350_results_with_indicators.csv', output.join('\n'));
}

runV350WithIndicators();
