...
async function runV501Current() {
  console.log(`--- [v5.0.1] 2025-2026 백테스트 시작 (Better Entry + 거래량) ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v501_20250101_20260331_results.csv', output.join('\n'));
  console.log(`\n--- 2025-2026 Results ---`);
