...
// --- Config (v6.0.0 2021 Full Year) ---
const SYMBOL = 'BTCUSDT';
const FETCH_START_TIME = new Date('2020-11-01T00:00:00+09:00').getTime();
const ACTUAL_START_TIME = new Date('2021-01-01T00:00:00+09:00').getTime();
const ACTUAL_END_TIME = new Date('2022-01-01T00:00:00+09:00').getTime();
...
async function runV600Full2021() {
  console.log(`--- [v6.0.0] 2021년 백테스트 ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v600_20210101_20211231_results.csv', output.join('\n'));
  console.log(`\n--- 2021 Full Year Results (v6.0.0) ---`);
