...
async function runV310Final() {
  console.log(`--- [v3.1.0] 백테스트: 2025-01-01 ~ 오늘 ---`);
  console.log(`조건: 5m(Stoch), 1h(MACD+Stoch), 1d(MACD+Stoch+Filter) | TP 3%, SL 15% | No Re-entry logic`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v310_results.csv', output.join('\n'));
}
