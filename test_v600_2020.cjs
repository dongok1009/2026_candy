...
const FETCH_START_TIME = new Date('2019-11-01T00:00:00+09:00').getTime();
const ACTUAL_START_TIME = new Date('2020-01-01T00:00:00+09:00').getTime();
const ACTUAL_END_TIME = new Date('2021-01-01T00:00:00+09:00').getTime();
...
async function runV600Full2020() {
  console.log(`--- [v6.0.0] 2020년 백테스트 ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v600_20200101_20201231_results.csv', output.join('\n'));
  console.log(`\n--- 2020 Full Year Results (v6.0.0) ---`);
