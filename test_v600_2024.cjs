...
// --- Config (v6.0.0 2024 Full Year) ---
const SYMBOL = 'BTCUSDT';
const FETCH_START_TIME = new Date('2023-11-01T00:00:00+09:00').getTime();
const ACTUAL_START_TIME = new Date('2024-01-01T00:00:00+09:00').getTime();
const ACTUAL_END_TIME = new Date('2025-01-01T00:00:00+09:00').getTime();
...
async function runV600Full2024() {
  console.log(`--- [v6.0.0] 2024년 백테스트 (1d StochRSI 제거 버전) ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v600_20240101_20241231_results.csv', output.join('\n'));
  console.log(`\n--- 2024 Full Year Results (v6.0.0 - 1d Stoch OFF) ---`);
