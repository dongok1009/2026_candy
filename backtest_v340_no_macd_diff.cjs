...
async function runV340LimitEntryNoMacdDiff() {
  console.log(`--- [v3.4.0 수정] 백테스트: MACD Hist Threshold 제거 ---`);
  console.log(`조건: 1d MACD-Signal 차이 300 조건 제거`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v340_no_macd_diff_results.csv', output.join('\n'));
}

runV340LimitEntryNoMacdDiff();
