                ...
                <div style={{ background: '#0b0e11', padding: '12px 16px', borderRadius: '12px', border: '1px solid #2b3139', marginBottom: '24px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '12px 16px', marginTop: '12px' }}>
                        <div className="input-group">
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', background: '#1e2329', padding: '4px 8px', minHeight: '41px', boxSizing: 'border-box', borderRadius: '6px', border: '1px solid #2b3139' }}>
                                <label style={{ display: 'flex', alignItems: 'center', gap: '5px', color: '#eaebed', fontSize: '13px', cursor: 'pointer', whiteSpace: 'nowrap' }}>
