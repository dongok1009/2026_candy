...
async function runV501Full2024Fixed() {
  console.log(`--- [v5.0.1] 2024년 백테스트 (필터 수정 완료: 1d StochRSI 추가) ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v501_20240101_20241231_results_fixed.csv', output.join('\n'));
  console.log(`\n--- 2024 Full Year Results (Fixed Filter) ---`);
