...
// --- Config (Adjusted for 2024 Full Year) ---
...
async function runV501Full2024() {
  console.log(`--- [v5.0.1] 2024년 전체 백테스트 시작 (Better Entry + 거래량) ---`);
  ...
  fs.writeFileSync('C:/dev/2026_candy/backtest_v501_2024_results.csv', output.join('\n'));
